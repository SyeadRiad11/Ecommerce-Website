...
// product inceasr and descrease 


const minus = document.querySelector('.minus');
const qualtity_value = document.querySelector('.qualtity_value input');
...
// qualtity_value.value =parseInt(qualtity_value.value) +1;
...
// const pro_added = document.querySelector('.pro_added');

// add_cart_btn.addEventListener('click' , ()=>{
// pro_added.classList.add('Cart_added') 

// });



// gift to other adress 

const gift_differnt_address = document.querySelector('.gift_differnt_address');
const other_data = document.querySelector('.other_data');
const gift_differnt_address_input = document.querySelector('.gift_differnt_address input');


gift_differnt_address.addEventListener('click' , ()=>{
other_data.classList.toggle('showOther_data') 
gift_differnt_address_input.checked = true;
